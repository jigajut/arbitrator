...
COINONE_HOST = 'api.coinone.co.kr'
...
class CoinOneConnection(object):
    ...
    def __init__(cls, compr=True, timeout=HTTP_TIMEOUT):
        ...
        if not cls.conn:
            ...
            cls.conn = HTTPSConnection(COINONE_HOST, strict=True, timeout=timeout)
...
class PublicAPIv3(CoinOneConnection):
